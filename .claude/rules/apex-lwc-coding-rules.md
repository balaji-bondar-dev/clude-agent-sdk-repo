...
_This ruleset is tool-agnostic. It works with GitHub Copilot, Cursor, Claude Code, Windsurf, Cline, Roo Code, or any AI-assisted coding tool that supports custom instructions._
